...
"[project]/src/data/users/index.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    const login = async (credentials)=>{
        ...
        const foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dummyUsers"].find((u)=>u.email.toLowerCase() === credentials.email.toLowerCase());
        if (!foundUser) {
            setLoading(false);
            return {
                success: false,
    ...
    const signup = async (data)=>{
        ...
        const existingUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dummyUsers"].find((u)=>u.email.toLowerCase() === data.email.toLowerCase());
        if (existingUser) {
            setLoading(false);
            return {
                success: false,
        ...
        const existingUsername = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$users$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dummyUsers"].find((u)=>u.username.toLowerCase() === data.username.toLowerCase());
        if (existingUsername) {
            setLoading(false);
            return {
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fba9c5f4._.js.map